...
import { OutlinedButton } from "@/components/video/buttons/OutlinedButton";
import useIsTab from "@/hooks/useIsTab";
import useIsMobile from "@/hooks/useIsMobile";
import { MobileIconButton } from "@/components/video/buttons/MobileIconButton";
                          ...
                          <div className={" bg-gray-600 py-1"}>
                            ...
                            <div>
                              <div className="flex p-3 pb-0">
                                <p className="ml-3 text-sm text-gray-100  text-center">
                                  {"SPEAKER"}
                                </p>
                              </div>
                              <div className="flex flex-col ">
